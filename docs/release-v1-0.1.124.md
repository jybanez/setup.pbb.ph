...
```text
Philippines / province 0722 / Cebu
```

## Summary

This is the official Cebu province build promoted from the passing v1-0.1.124 test run.

The release includes:

- Hotline baseline-schema seed-skip fix for production-pruned bundles
...
- operator test install passed on S5
